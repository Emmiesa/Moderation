package club.flower.moderation.freeze;
...
public class Freeze {
    ...
    public void freezePlayer(boolean message) {
        if (Staff.getStaff(uuid) != null) {
            ...
            staffPlayer.sendMessage(CC.translate("&cYou can't frozen " + getName() + " because is staff."));
            return;
        }
        ...
        if (message) {
            ...
            player.sendMessage(CC.translate("&cYou have been frozen by &c" + staff.getName()));
        }
    }
    ...
    public void unFreezePlayer(boolean message) {
        if (Staff.getStaff(uuid) != null) {
            Player staffPlayer = staff.getPlayer();
            staffPlayer.sendMessage(CC.translate("&cYou can't unfrozen " + getName() + " because is staff."));
            return;
        }
        ...
        if (message) {
            ...
            player.sendMessage(CC.translate("&cYou have been unfrozen by &c" + staff.getName()));
        }
